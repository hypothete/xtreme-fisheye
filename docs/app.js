import {WebGL1Renderer, Scene, PerspectiveCamera, BoxBufferGeometry, MeshLambertMaterial, Color, Mesh, WebGLCubeRenderTarget, CubeCamera, LinearMipmapLinearFilter, Object3D, Vector3, BackSide, PointLight} from "./_snowpack/pkg/three.js";
...
import fisheyeShader from "./fisheye.js";
...
async function start() {
  ...
  scene.add(player);
  const cubeRenderTarget = new WebGLCubeRenderTarget(1024, {generateMipmaps: true, minFilter: LinearMipmapLinearFilter});
